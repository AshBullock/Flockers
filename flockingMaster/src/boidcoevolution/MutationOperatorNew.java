 ...
 * @since 1.0
 */
public class MutationOperatorNew
   ...
   * @since 3.0
   */
  public MutationOperatorNew(final Configuration a_conf)
      throws InvalidConfigurationException {
    super(a_conf);
    System.out.println("m_mutationRate is ------- " + m_config.m_mutationRate);
   ...
   * @since 1.1
   */
  public MutationOperatorNew(final Configuration a_config,
    ...
    for (int i = 0; i < size; i++) {
      ...
      for (int j = 0; j < genes.length; j++) {
        if (m_mutationRateCalc != null) {
          ...
          // ----------------------------------------------------------
          if (j>=genes.length-2) {
        	  //System.out.println("Gene j is: " + genes[j]);
        	  mutate = (generator.nextInt(m_config.m_mutationRate/100) == 0);
          }
          else
  ...
  public int compareTo(Object a_other) {
    ...
    MutationOperatorNew op = (MutationOperatorNew) a_other;
    if (m_mutationRateCalc == null) {
