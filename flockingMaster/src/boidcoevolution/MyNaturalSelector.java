...
/*
 * Modified WeightedRouletteSelector originally a part of JGAP.
 *
 ...
 * @since 1.0
 */
public class MyNaturalSelector
   ...
   * @since 3.0
   */
  public MyNaturalSelector(Configuration a_config)
      throws InvalidConfigurationException {
    super(a_config);
  ...
  public synchronized void selectChromosomes(int a_howManyToSelect,
      Population a_to_pop) {
	  //System.out.println("How many to select: " + a_howManyToSelect);
	  //System.out.println("How many to select: " + numberToSelect);
    ...
    for (int i = 0; i < numberToSelect; i++) {
      ...
      if (a_to_pop.contains(selectedChromosome)) {
        IHandler cloner = getConfiguration().getJGAPFactory().
  ...
  public void setNumberToSelect(int number)
  {
	  this.numberToSelect = number;
  }
  ...
  public Object clone() {
    try {
    	//System.out.println("Clone is being run...");
      MyNaturalSelector result = new MyNaturalSelector(
          getConfiguration());
  ...
  public boolean equals(Object o) {
	  MyNaturalSelector other = (MyNaturalSelector) o;
    if (other == null) {
      return false;
    }
